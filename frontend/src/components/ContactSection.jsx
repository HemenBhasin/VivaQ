  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: 'github',
      url: 'https://github.com/HemenBhasin',
      color: 'hover:text-gray-400'
    },
    {
      name: 'LinkedIn',
      icon: 'linkedin',
      url: 'https://www.linkedin.com/in/hemen-bhasin/',
    ...
    },
    {
      name: 'Email',
      icon: 'mail',
      url: 'mailto:hemenbhasin@gmail.com',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-purple-200 max-w-3xl mx-auto">
            Have questions about VivaQ? Want to collaborate? We'd love to hear from you!
          </p>
        </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="5"
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-purple-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 resize-none"
          ...
          >
            <div>
              ...
              <p className="text-purple-200 leading-relaxed mb-8">
                Follow us on social media for the latest updates, tips, and insights about 
                AI-powered education and quiz generation.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {socialLinks.map((link, index) => (
                <motion.a
                  ...
                  viewport={{ once: true }}
                  className={`flex items-center space-x-4 p-4 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 transition-all duration-300 ${link.color}`}
                >
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10">
              ...
              <div className="space-y-3 text-purple-200">
                <div className="flex items-center space-x-3">
                  ...
                  <span>hemenbhasin@gmail.com</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span>Global - Available Worldwide</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
